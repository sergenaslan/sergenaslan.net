<template>
    <!-- project classındaki hover animasyonu https://codepen.io/ dan copy/paste ile alınmıştır -->
    <div class="project" :class="{showMoreClass : shortText }" >
        <div class="projectImage">
            <img :src="awards.projectImage" class="imgRespon" alt="">
        </div>
        ...
        <div class="projectComment">
             ...
             {{ shortText ?  awards.commet : awards.commet.substring(0, 103) }}
             <br>
            <a @click="showMore" class="showMore"> {{ shortText ? "Daha Az Göster" : "Devamını Göster"   }} </a>
        </div>
        <div class="openLink">
            <a :href="awards.chromeLink">
...
export default {
    ...
    methods: {
        myEventHandler(e) {
            this.windowsWidth = e.currentTarget.innerWidth;
        },
        showMore(){
